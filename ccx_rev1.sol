...
contract TestToken is Context, IBEP20, Ownable {
    ...
    constructor (address cOwner) Ownable(cOwner) {
        _rOwned[seedRound] = (_rTotal / 100) * 5;
        _rOwned[privateSale] = (_rTotal / 100) * 30;
        _rOwned[publicSale] = (_rTotal / 100) * 10;
        _rOwned[dexLiquidity] = (_rTotal / 100) * 15;
        _rOwned[team] = (_rTotal / 100) * 15;
        _rOwned[partnersAndAdvisers] =  (_rTotal / 100) * 10;
        _rOwned[cexLiquidity] =  (_rTotal / 100) * 5;
        _rOwned[marketing] =  (_rTotal / 100) * 10;
    ...
    function setTaxFee(uint256 _fee) external onlyOwner {
        require(_fee <= 100, "Tax fee may be less than or equal to 10% ");
    ...
    function setBurnFee(uint256 _fee) external onlyOwner {
        require(_fee <= 100, "Burn fee may be less than or equal to 10% ");
